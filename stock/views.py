...
def stockmodel(request):
    ...
    if request.method == "POST":
        ...
        stock_file_name = "C:/Users/USER/PycharmProjects/deep_Learning/stock/refStage/stock/" + item + ".csv"
        ...
        if update == "update":
            ...
            browser = webdriver.Chrome("C:/Users/USER/PycharmProjects/deep_Learning/static/resource/chromedriver.exe")
        ...
        return render(request, 'stock/mystock_results.html', resp)
